...
contract OptoUtils {
  ...
  // Function to update the isCall flag
    function setIsCall(bytes1 flags, bool isCallOption) pure public returns (bytes1) {
        if (isCallOption) {
    ...
    function setHasToPay(bytes1 flags, bool hasToPayOption)  pure public returns (bytes1)  {
        if (hasToPayOption) {
    ...
    function setIsActive(bytes1 flags, bool isActiveOption)  pure public returns (bytes1) {
        if (isActiveOption) {
    ...
    function setIsPaused(bytes1 flags, bool isPausedOption)  pure public returns (bytes1) {
        if (isPausedOption) {
